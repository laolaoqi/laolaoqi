              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6 py-2">
                ...
                >
                  <img
                    ...
                    className="w-28 h-28 rounded-lg border border-[#29a9eb]/20 group-hover:border-[#29a9eb]/50 transition-all"
                  />
                </a>
                <div className="space-y-3">
                  <div className="flex items-center gap-2">
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-base font-bold text-[#29a9eb] hover:text-[#29a9eb]/80 transition-colors"
                    >
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <a
                      ...
                      className="text-base font-bold text-[#00d4ff] hover:text-[#00d4ff]/80 transition-colors"
                    >
                      laolaoqi@126.com
                    </a>
                  </div>
                  <p className="text-sm text-foreground/50">
                    欢迎通过 Telegram 或邮件联系我们，获取更多投资资讯或反馈建议。
                  </p>
                </div>
              </div>
            </HudPanel>
